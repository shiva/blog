...
[Dave Winer](http://www.scripting.com/stories/2007/02/21/daveWinerBio.html), the inventor of RSS, wrote today about twitter's latest API update for supporting the [lists feature](http://blog.twitter.com/2009/09/soon-to-launch-lists.html)

> It turns out there's an API call that retrieves the timeline for a list, and it works exactly like the API call that retrieves the timeline for an account. So much so that I didn't even have to change the [glue script](http://listings.opml.org/verbs/apps/twitter/getTimeLine.html), I pass in a [different URL](http://images.scripting.com/archiveScriptingCom/2009/10/25/gluescript.gif) and it just worked &gt; [orig link](http://www.scripting.com/stories/2009/10/25/goodApiDesignAtTwitter.html)
