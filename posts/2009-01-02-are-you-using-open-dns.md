...
[OpenDNS](http://www.opendns.com/) is for you (well, for the dog, you'll have to move your ass and get one yourself).  It is quite trivial to setup and really speeds up your browsing speed. You can can set it up for each computer that you use, or better still, change the configuration on your router, which would apply across all machine connected through that router.
...
Isn't this enough reason to spend 2 minutes configuring openDNS?! What are you waiting for.. [go on](http://www.opendns.com/)!