...
So I pulled Sharpdevelop 2.1.0, (monodevelop was apparently forked from sharpdevelop), off [here](http://www.icsharpcode.net/OpenSource/SD/Download/), and I installed it. As per the instructions found [here](http://community.sharpdevelop.net/blogs/mattward/archive/2005/10/12/SharpDevelopAndMono.aspx), I tried to compile the application, but SharpDevelop, threw a twister at me. It said "mono is not installed". I tried hunting around for some options somewhere that told SharpDevelop where to look for mono, but was able to find no help.
...
[![first C# app-Large](/images/first-csharp-app-big.jpg)](http://shvelmur.com/wpress/wp-content/uploads/2006/12/first-csharp-app-big.jpg)